...
export default function Connect() {
    ...
    return(
        ...
        <div className='connect'>
          <h2>CONNECT</h2>
          <h3>#woodlandparkzoo</h3>
        </div>
        <div className='social'>
          <a href="#">      
            <svg xmlns="http://www.w3.org/2000/svg" width="5  0" height="60" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
          ...
          <a href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
